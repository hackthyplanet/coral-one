...
function preload(){
	...
	//song = loadSound('assets/precious.mp3')
}
...
function draw () {
	...
	ambientLight(lerpColor(LstartColor, LnewColor, smoothstep(0.3,0.9,Lamt)));
	Lamt += 0.0001;
	 if(Lamt >= 1){
	  Lamt = 0.0
...
function lighting(){
	...
	//pointLight (242, 205, 136, 100000.0, 200000.0, 200000.0);
	//pointLight (242, 187, 187, 0.0, -200.0, -200.0);
